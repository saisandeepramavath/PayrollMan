        ...
        <div className="mt-2">
          ...
          <div className="space-y-3">
            {PERMISSION_LABELS.map(({ key, label, description }) => (
              <div key={key} className="flex items-center justify-between gap-4 py-2 border-b border-slate-800 last:border-0">
                <div>
...
export function AdminPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto">
      ...
      {/* Tab bar */}
      <div className="flex gap-1 mb-6 p-1 rounded-xl bg-slate-900 border border-slate-800 w-fit">
          ...
          <CardHeader>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="pl-8 pr-4 py-1.5 text-xs rounded-lg border border-slate-700 bg-slate-900 text-slate-100 placeholder-slate-500 focus:outline-none focus:ring-1 focus:ring-indigo-500/50 transition-all w-48"
              />
            </div>
          </CardHeader>
                      ...
                      <td className="px-6 py-4">
                        {u.is_superuser ? (
                          ...
                          <select
                            ...
                            className="text-xs rounded-md border border-slate-700 bg-slate-900 text-slate-100 px-2 py-1 focus:outline-none focus:ring-1 focus:ring-indigo-500/50"
                          >
                ...
                <Card key={role.id}>
                  <CardHeader>
                    <div className="flex items-center gap-2">
                      ...
                      <div>
                        <p className="text-sm font-semibold text-slate-200">{role.display_name}</p>
        ...
        <CardBody className="!p-0">
          <div className="divide-y divide-slate-800">
            {projects?.slice(0, 10).map((project) => {
              ...
              return (
                <div key={project.id} className="px-6 py-4 flex items-center justify-between hover:bg-slate-800/30 transition-colors">
                  <div className="flex items-center gap-3">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <span className={`text-xs px-2 py-1 rounded-md border font-medium ${
                      project.status === 'active' ? 'text-emerald-400 bg-emerald-400/10 border-emerald-400/20'
                      : project.status === 'completed' ? 'text-sky-400 bg-sky-400/10 border-sky-400/20'
