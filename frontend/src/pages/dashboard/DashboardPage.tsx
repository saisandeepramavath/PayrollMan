    ...
    <div className="max-w-6xl mx-auto space-y-6">
            ...
            <>
              ...
              <div className="flex items-center gap-1 ml-1">
                ...
                <button
                  ...
                  className="p-1.5 rounded-md text-slate-600 hover:text-slate-400 hover:bg-slate-700/50 transition-colors"
                  title="Add note"
                >
      ...
      {showNotes && !activePunch && (
        <input
          ...
          className="w-full sm:max-w-sm rounded-lg border border-slate-700 bg-slate-900 px-3 py-2 text-sm text-slate-100 placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-indigo-500/50 transition-all -mt-3"
        />
      )}
        ...
        <Card className="lg:col-span-3">
          <CardHeader className="py-3.5 px-5">
            <div className="flex items-center gap-2">
              ...
              <h2 className="text-xs font-semibold text-slate-400 uppercase tracking-wider">Recent Timecards</h2>
            </div>
            <Link
              to="/timecards"
              ...
              <div className="divide-y divide-slate-800/60">
                {recentProjects.map((project) => (
                  <Link
                    ...
                    className="px-5 py-3 flex items-center justify-between hover:bg-slate-800/30 transition-colors block"
                  >
                    <div className="flex flex-col min-w-0">
        ...
        <Card>
          <CardHeader className="py-3.5 px-5">
            <div className="flex items-center gap-2">
              ...
              <h2 className="text-xs font-semibold text-slate-400 uppercase tracking-wider">Attendance</h2>
                ...
                <div key={wg.key}>
                  ...
                  {wg.entries.map((entry) => {
                    ...
                    return (
                      <div
                        key={entry.id}
                        className="flex items-center gap-3 px-5 py-2.5 hover:bg-slate-800/20 transition-colors group"
                      >
...
function MiniStat({
  ...
  return (
    <div className="rounded-xl border border-slate-800 bg-slate-900/60 px-4 py-3 flex items-center gap-3 hover:border-slate-700 transition-colors">
      <div className={`flex items-center justify-center w-8 h-8 rounded-lg bg-slate-800 ${accent}`}>
        {icon}
      </div>
      <div>
